export default {
  ...
  deposit: {
    title: "Nạp tiền",
    vietqrTitle: "Thanh toán VietQR",
    amountLabel: "Số tiền (VND)",
    amountPlaceholder: "Nhập số tiền (tối thiểu 1.000 VND)",
    qrPlaceholder: "Nhập số tiền để tạo mã QR",
    generatingBtn: "Đang tạo...",
    generateBtn: "Tạo mã QR",
    qrError: "Không thể tạo mã QR",
    qrApiError: "Lỗi kết nối dịch vụ thanh toán",
    otherMethodsTitle: "Phương thức thanh toán khác",
