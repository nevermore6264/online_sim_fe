    ...
    <div class="auth-form">
      ...
      <form @submit.prevent="handleLogin">
        <div class="input-group">
          ...
          <InputText id="username" v-model="loginData.username" placeholder="Username" required class="auth-input" />
        </div>
        <div class="input-group">
          <label for="password">{{ $t("landing.password") }}</label>
          <div class="password-input-container">
            <InputText id="password" v-model="loginData.password" :type="showPassword ? 'text' : 'password'"
